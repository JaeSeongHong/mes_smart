...
DATABASES = {
    'default': {
        ...
        'PORT': '3306',
        'OPTIONS': {
            'init_command': "SET sql_mode='STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_VALUE_ON_ZERO,NO_ENGINE_SUBSTITUTION'",
            }
    }
}
...
MEDIA_URL = 'http://127.0.0.1:80/data/'  # For debug
# MEDIA_URL = 'http://192.168.0.12:9000/data/'  # For debug
# MEDIA_ROOT = os.path.join(BASE_DIR, 'data')
MEDIA_ROOT = '//seoul-soft/smart'
