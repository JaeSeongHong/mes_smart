...
from api.order.orders_view import OrdersViewSet, OrdersItemsViewSet, OrdersInItemsViewSet, OrdersByListViewSet, \
    OrdersOnlyRead, OrdersitemsOnlyRead, OrdersInputRead
...
router.register(r'order_s_updateBylist', OrdersByListViewSet) #발주서 마감, 삭제
# 외주관리
...
urlpatterns = [
    ...
    url("order_s/read/", OrdersOnlyRead.as_view(), name='OrdersOnlyRead'),
    url("order_s_items/read/", OrdersitemsOnlyRead.as_view(), name='OrdersitemsOnlyRead'),
    url("order_s/input_read/", OrdersInputRead.as_view(), name='OrdersInputRead'),
    ...
    path('project/project_view/', project_view),
    # url('basic_information/enterprises_read/', EnterpriseMaster_read.as_view(),
    #                   name='basic_information_enterprises_read'),
